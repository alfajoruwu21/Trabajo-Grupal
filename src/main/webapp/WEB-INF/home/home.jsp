							...
							<div id="carouselExampleControls" class="carousel slide"
								...
								<div class="carousel-inner">
											...
											<c:forEach items="${pets}" var="pet">
												<div class="card" style="width: 18rem;">
													...
													<div class="card-body">
														...
														<a href="/mostrar/${pet.id}" class="btn btn-primary">Más
															info</a>
													</div>
												</div>
											</c:forEach>
									...
									<div class="carousel-item">
										<div class="cards-wrapper">
											<div class="card" style="width: 18rem;">
												<img src="img/cards/img-card-4.jpg" class="card-img-top"
													alt="...">
												<div class="card-body">
											...
											<div class="card" style="width: 18rem;">
												<img src="img/cards/img-card-5.jpg" class="card-img-top"
													alt="...">
												<div class="card-body">
													<h5 class="card-title">Card title</h5>
													<p class="card-text">Some quick example text to build
											...
											<div class="card" style="width: 18rem;">
												<img src="img/cards/img-card-6.jpg" class="card-img-top"
													alt="...">
												<div class="card-body">
													<h5 class="card-title">Card title</h5>
													<p class="card-text">Some quick example text to build
